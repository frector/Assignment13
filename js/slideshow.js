...
const createSlideshow = function () {
    ...
    //GET SPEED VARIABLE
    const selectSpeed = function (){
        let speed = document.getElementById('speed');
        for (let i = 0; i < speedList.length; i += 1) {
        speed.add(new Option(speedList[i][0], i)); 
        }
    }
    //SET SPEED VAIABLE
    ...
    return {
        ...
        startSlideShow: function () {
            ...
            timer = setInterval(displayNextImage, setSpeed);
            return this;
        },
...
window.addEventListener('load', () => {
    ...
    let setSpeed = document.getElementById('set speed');
